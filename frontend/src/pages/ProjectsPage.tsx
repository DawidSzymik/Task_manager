                ...
                {projects.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {projects.map((project) => (
                            <div
                                key={project.id}
                                className="bg-gray-900 border border-gray-800 rounded-lg p-6 hover:border-primary-500 transition-colors cursor-pointer"
                            ...
                            >
                                <div className="flex items-start justify-between mb-4">
                                    ...
                                    <div className="w-12 h-12 bg-primary-500 bg-opacity-20 rounded-lg flex items-center justify-center flex-shrink-0">
