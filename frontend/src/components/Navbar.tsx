// src/components/Navbar.tsx - LOGO NAD SIDEBARREM
        ...
        <>
            <nav className="bg-gray-900 border-b border-gray-800 sticky top-0 z-50 shadow-lg">
                <div className="flex items-center justify-between h-16">
                    {/* Logo - nad sidebarrem, stała szerokość */}
                    <div className="w-64 flex-shrink-0 px-6">
                        ...
                        >
                            <div className="inline-flex items-center gap-3">
                                <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-gradient-to-br from-blue-500 to-emerald-500 shadow-[0_4px_12px_rgba(16,185,129,0.5)]">
                                    <svg
                                        fill="none"
                                        stroke="currentColor"
                                        viewBox="0 0 24 24"
                                ...
                                <div className="text-2xl font-extrabold bg-gradient-to-br from-blue-500 to-emerald-500 bg-clip-text text-transparent tracking-tight">
                                    TaskManager
                                </div>
                            </div>
                        </div>
                    ...
                    {/* Search Button - 50px na prawo od logo */}
                    <div className="flex-1 flex items-center ml-[50px]">
                        <button
                            onClick={() => setShowSearch(true)}
                            className="flex items-center gap-2 px-6 py-2 bg-gray-800 hover:bg-gray-700 rounded-lg text-gray-400 hover:text-white transition min-w-[240px]"
                        >
